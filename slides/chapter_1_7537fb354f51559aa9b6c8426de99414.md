...
Now to get the value of β where it minimizes the cost function we multiply both sides by the inverse of X transpose X. As we know a vector multiplied by its inverse gives us the identity matrix.
